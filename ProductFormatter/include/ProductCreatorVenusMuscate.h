...
#ifndef PRODUCTFORMATTER_INCLUDE_PRODUCTCREATORVENUSMUSCATE_H_
#define PRODUCTFORMATTER_INCLUDE_PRODUCTCREATORVENUSMUSCATE_H_
...
private:
	...
	/**
	 * @brief Set the BandInformation-vector for Venus
	...
	/**
	 * @brief Build the product directory according to the Venus Muscate conventions
	 * @param datetime Product datetime
	 * @param productType Type of the product
	 * @param productVersion Version of the product
	 * @return string of the Venus-product directory
	 */
	std::string BuildFileNameVenus(const std::string &datetime, const std::string &productType, const std::string &productVersion);
...
#endif /* PRODUCTFORMATTER_INCLUDE_PRODUCTCREATORVENUSMUSCATE_H_ */
